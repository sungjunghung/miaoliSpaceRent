      ...
      <div class="card-body">
        ...
        <table class="table">
          <tbody>
            ...
            <tr><td class="text-base-content/50 w-28">預約場館</td><td class="font-medium">{{ booking.venueName }}</td></tr>
            ...
            <tr v-if="booking.cancelDeadline && !['completed', 'cancelled', 'cancelled_expired', 'cancelled_rejected'].includes(booking.status)">
              <td class="text-base-content/50">取消期限</td><td>{{ booking.cancelDeadline }}</td>
            </tr>
